  ...
  return (
    <>
      <SEO 
        ...
        keywords="услуги аренды спецтехники, благоустройство дворов, копка траншей, канализация под ключ, доставка материалов, вывоз мусора, аренда спецтехники Владикавказ"
