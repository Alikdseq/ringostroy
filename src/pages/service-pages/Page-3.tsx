...
export default function SewerageService() {
  ...
  const serviceData = {
    ...
    shortDescription: "Услуга канализации под ключ включает в себя полный цикл работ по проектированию, монтажу, подключению и сдаче в эксплуатацию канализационной системы.",
    secondParagraph: "Мы предлагаем комплексное решение для организации канализационной системы на вашем участке с гарантией качества и соблюдением всех строительных норм и правил.",
  ...
  const seoData = servicesSeoData['kanalizaciya-pod-klyuch' as keyof typeof servicesSeoData];
  const serviceSchema = generateServiceSchema(serviceData.title, serviceData.shortDescription);
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Главная', url: '/' },
    { name: 'Услуги', url: '/services' },
    { name: serviceData.title, url: '/services/kanalizaciya-pod-klyuch' }
  ]);
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              <img
                ...
                alt="Процесс установки канализации"
                style={{
                  width: '100%',
                  height: '100%',
                  display: 'block',
              ...
              <div style={{
                ...
                <div style={{ marginBottom: '50px', textAlign: 'center' }}>
                  <div style={{
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Проектирование канализационной системы</span>
                  </div>
                  <div style={{
                    marginBottom: '12px',
                    display: 'flex',
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Рытьё котлованов и траншей</span>
                  </div>
                  <div style={{
                    marginBottom: '12px',
                    display: 'flex',
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Монтаж канализационных колодцев и труб</span>
                  </div>
                  <div style={{
                    marginBottom: '12px',
                    display: 'flex',
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Подключение к центральной канализации</span>
                  </div>
                </div>
              </div>
            </div>
