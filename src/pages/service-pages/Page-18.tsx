...
export default function FenceConstructionService() {
  ...
  const serviceData = {
    ...
    shortDescription: "Строительство заборов из профнастила, дерева, камня и других материалов.",
  ...
  const seoData = servicesSeoData['stroitelstvo-zaborov' as keyof typeof servicesSeoData];
  const serviceSchema = generateServiceSchema(serviceData.title, serviceData.shortDescription);
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Главная', url: '/' },
    { name: 'Услуги', url: '/services' },
    { name: serviceData.title, url: '/services/stroitelstvo-zaborov' }
  ]);
              ...
              <div style={{
                ...
                <div style={{ marginBottom: isMobile ? '30px' : '50px', textAlign: 'center' }}>
                  <p style={{
                    ...
                    Процесс включает в себя разработку проекта, расчёт длины, высоты и расхода материалов, возведение фундамента, кладку кирпича или камня, установку опорных столбов и крепление секций к ним. Для строительства забора необходимо соблюдать правила и нормативы, касающиеся ограждений, а также получить разрешение на строительство.
                  </p>
                </div>
              </div>
            </div>
