...
export default function SitePlanningService() {
  ...
  const serviceData = {
    title: "Планировка и очистка участка",
    shortDescription: "Полный комплекс работ по планировке и очистке участка от мусора, растительности и старых построек.",
  ...
  const seoData = servicesSeoData['planirovka-i-ochistka-uchastka' as keyof typeof servicesSeoData];
  const serviceSchema = generateServiceSchema(serviceData.title, serviceData.shortDescription);
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Главная', url: '/' },
    { name: 'Услуги', url: '/services' },
    { name: serviceData.title, url: '/services/planirovka-i-ochistka-uchastka' }
  ]);
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              <img
                ...
                alt="Планировка и очистка участка"
                style={{
                  width: '100%',
                  height: '100%',
                  display: 'block',
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              <img
                ...
                alt="Процесс планировки участка"
                style={{
                  width: '100%',
                  height: '100%',
                  display: 'block',
            ...
            <div style={{ 
              ...
              <div style={{ marginBottom: isMobile ? '50px' : '100px' }}>
                <p style={{
                  ...
                  Это подготовка территории к благоустройству. В рамках очистки вырубают сухостой, скашивают сорные травы, перекапывают грунт, убирают корни. Если на территории есть деревья или кустарники, их оценивают: ценные растения оставляют или пересаживают на новое место, а малоценные удаляют. Строительный мусор собирают и вывозят. Также убирают старое мощение, асфальтирование, малые архитектурные формы или другие элементы благоустройства, которые не будут использоваться в новом оформлении территории.
                </p>
              </div>
            </div>
          </div>
