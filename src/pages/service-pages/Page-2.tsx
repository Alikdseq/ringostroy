...
export default function TrenchDiggingService() {
  ...
  const serviceData = {
    title: "Копка траншей",
    shortDescription: "Копка траншей - это один из основных видов земляных работ, который необходим при прокладке коммуникаций, водопровода, канализации, кабельных линий и других инженерных систем.",
    secondParagraph: "Наша компания предоставляет профессиональные услуги по копке траншей с использованием современной спецтехники. Мы гарантируем высокое качество работ, соблюдение всех норм и требований безопасности, а также своевременное выполнение заказа.",
  ...
  const seoData = servicesSeoData['kopka-transej' as keyof typeof servicesSeoData];
  const serviceSchema = generateServiceSchema(serviceData.title, serviceData.shortDescription);
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Главная', url: '/' },
    { name: 'Услуги', url: '/services' },
    { name: serviceData.title, url: '/services/kopka-transej' }
  ]);
              ...
              <div style={{
                ...
                <div style={{ marginBottom: '50px', textAlign: 'center' }}>
                  <div style={{
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Использование профессиональной спецтехники</span>
                  </div>
                  <div style={{
                    marginBottom: '12px',
                    display: 'flex',
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Соблюдение всех норм и требований безопасности</span>
                  </div>
                  <div style={{
                    marginBottom: '12px',
                    display: 'flex',
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Высокая скорость выполнения работ</span>
                  </div>
                  <div style={{
                    marginBottom: '12px',
                    display: 'flex',
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Доступные цены и индивидуальный подход</span>
                  </div>
                </div>
              </div>
            </div>
