...
export default function MaterialDeliveryService() {
  ...
  const serviceData = {
    title: "Доставка чернозема, балласта, щебенки, песка",
    shortDescription: "Доставка всех видов сыпучих материалов для строительства и благоустройства.",
    ...
    galleryImages: [
      '/images/images-imag/gal11-1.png',
      '/images/images-imag/gal11-2.png', 
      '/images/images-imag/gal11-3.png',
      '/images/images-imag/gal11-4.png',
    ]
  };
  ...
  const seoData = servicesSeoData['dostavka-chernozema-ballasta-shchebenki-peska' as keyof typeof servicesSeoData];
  const serviceSchema = generateServiceSchema(serviceData.title, serviceData.shortDescription);
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Главная', url: '/' },
    { name: 'Услуги', url: '/services' },
    { name: serviceData.title, url: '/services/dostavka-chernozema-ballasta-shchebenki-peska' }
  ]);
              ...
              <div style={{
                ...
                <div style={{ marginBottom: isMobile ? '30px' : '50px', textAlign: 'center' }}>
                  <p style={{
                    ...
                    Предлагаем надёжные услуги по доставке грузов, гарантируя своевременность и сохранность груза. Мы успешно сотрудничаем с компаниями и частными лицами по доставке различных видов сыпучих материалов, включая песок, щебень, гравий, грунт и многое другое. Наша организация обеспечивает выполнение всех обязательств и оперативное предоставление услуг. Перевозка сыпучих грузов – одна из наиболее востребованных транспортных услуг. Она часто необходима крупным компаниям, небольшим фирмам, частным лицам. Мы доставляем любые объемы грузов на выгодных условиях и по приемлемым ценам. Наличие большого автопарка спецтехники позволяет нашим клиентам выбрать транспортное средство, наиболее соответствующее их потребностям.
                  </p>
                </div>
              </div>
            </div>
