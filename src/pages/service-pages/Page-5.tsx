...
export default function FBSBlocksService() {
  ...
  const serviceData = {
    title: "Доставка и установка ФБС блоков",
    shortDescription: "ФБС (фундаментные блоки стеновые) - это железобетонные изделия, используемые при строительстве фундаментов, подвалов и цокольных этажей зданий.",
    secondParagraph: "Мы осуществляем доставку и профессиональную установку ФБС блоков любого размера. Наши специалисты имеют опыт работы с различными типами фундаментов и гарантируют качественную сборку конструкций.",
  ...
  const seoData = servicesSeoData['dostavka-i-ustanovka-fbs-blokov' as keyof typeof servicesSeoData];
  const serviceSchema = generateServiceSchema(serviceData.title, serviceData.shortDescription);
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Главная', url: '/' },
    { name: 'Услуги', url: '/services' },
    { name: serviceData.title, url: '/services/dostavka-i-ustanovka-fbs-blokov' }
  ]);
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              <img
                ...
                alt="Доставка и установка ФБС блоков"
                style={{
                  width: '100%',
                  height: '100%',
                  display: 'block',
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              <img
                ...
                alt="Процесс установки ФБС блоков"
                style={{
                  width: '100%',
                  height: '100%',
                  display: 'block',
              ...
              <div style={{
                ...
                <div style={{ marginBottom: '50px', textAlign: 'center' }}>
                  <div style={{
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Доставка ФБС блоков на объект</span>
                  </div>
                  <div style={{
                    marginBottom: '12px',
                    display: 'flex',
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Разгрузка и установка на фундамент</span>
                  </div>
                  <div style={{
                    marginBottom: '12px',
                    display: 'flex',
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Проверка горизонтальности и вертикальности</span>
                  </div>
                  <div style={{
                    marginBottom: '12px',
                    display: 'flex',
                    ...
                    <span style={{ textAlign: 'left', flex: 1 }}>Заделка швов и герметизация</span>
                  </div>
                </div>
              </div>
            </div>
