...
export default function FoundationConstructionService() {
  ...
  const serviceData = {
    ...
    shortDescription: "Полный цикл работ по устройству фундаментов различных типов.",
  ...
  const seoData = servicesSeoData['stroitelstvo-fundamentov' as keyof typeof servicesSeoData];
  const serviceSchema = generateServiceSchema(serviceData.title, serviceData.shortDescription);
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Главная', url: '/' },
    { name: 'Услуги', url: '/services' },
    { name: serviceData.title, url: '/services/stroitelstvo-fundamentov' }
  ]);
              ...
              <div style={{
                ...
                <div style={{ marginBottom: isMobile ? '30px' : '50px', textAlign: 'center' }}>
                  <p style={{
                    ...
                    Некоторые этапы строительства фундаментов: Подготовительные работы. Расчистка и планировка участка, разметка осей будущего здания, снятие плодородного слоя почвы, организация водоотвода, доставка материалов и оборудования. Земляные работы. Рытьё котлована или траншей под фундамент, устройство дренажной системы (при необходимости), уплотнение грунта, устройство песчаной или щебёночной подушки. Устройство опалубки и армирование. Установка опалубки согласно проектным размерам, вязка арматурного каркаса, установка закладных деталей и проёмов для коммуникаций. Бетонирование. Приготовление бетонной смеси, укладка бетона в опалубку, уплотнение бетона вибраторами, выравнивание поверхности. Уход за бетоном и снятие опалубки. Обеспечение правильного температурно-влажностного режима твердения, защита бетона от механических повреждений и атмосферных воздействий, снятие опалубки после набора бетоном достаточной прочности (обычно через 7–14 дней). Гидроизоляция фундамента. Защита фундамента от воздействия влаги и продление срока его службы. Обратная засыпка и благоустройство. Засыпка пазух фундамента с послойным уплотнением, устройство систем дренажа и ливневой канализации, планировка территории, благоустройство прилегающей территории.
                  </p>
                </div>
              </div>
            </div>
